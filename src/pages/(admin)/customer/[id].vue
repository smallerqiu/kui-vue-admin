...
const statusBadge = computed(
  () =>
    ({ active: "success", follow: "processing", risk: "warning" })[
      customer.value.status
    ] as BadgeStatusType,
);
const events: Array<{
  ...
  {
    title: "完成订单交付",
    description: "企业协作平台专业版已完成授权交付",
    time: "今天 11:20",
    icon: CheckCheck,
  },
  {
    title: "客户回访",
    description: "客户对数据报表功能提出了新需求",
    time: "昨天 16:40",
    icon: ContactRound,
  },
  {
    title: "签署续约合同",
    description: "年度服务续约合同已完成电子签署",
    time: "8 月 18 日",
    icon: FileText,
  },
  {
    title: "创建订单",
    description: "购买企业协作平台专业版",
    time: "8 月 12 日",
    icon: ShoppingCart,
  },
];
