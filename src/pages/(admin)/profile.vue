            ...
            <TabPanel key="preference" title="偏好设置">
              <div class="preference-list">
                ...
                <div>
                  ...
                  <Switch v-model="preferenceStore.notification" />
                </div>
                <div>
                  <div>
                    <strong>页面水印</strong>
                  ...
                  <Switch v-model="preferenceStore.watermark" />
                </div>
              </div>
            </TabPanel>
          </Tabs>
...
const securityItems: Array<{
  ...
  {
    title: "登录密码",
    description: "建议定期更换高强度密码",
    action: "修改",
    icon: KeyRound,
  },
  {
    title: "安全邮箱",
    description: "admin@k-ui.cn",
    action: "更换",
    icon: MailCheck,
  },
  {
    title: "绑定手机",
    description: "已绑定 000 **** 0000",
    action: "更换",
    icon: Smartphone,
  },
  {
    title: "两步验证",
    description: "提升账号登录安全性",
    action: "开启",
    icon: ShieldCheck,
  },
];
...
@media (max-width: 560px) {
  .security-list :deep(.k-feature-card) {
    align-items: flex-start;
    flex-wrap: wrap;
  }
  .security-list :deep(.k-feature-card-extra) {
    width: 100%;
    margin-left: 40px;
  }
}
